...
function toplevel:import(lex, info)
   local mode = lex:ident('"weak" or "cspublic"', 'opt') or "cspublic"
   if mode ~= 'weak' and mode ~= 'cspublic' then
      return lex:error '"weak or "cspublic" expected'
   end
